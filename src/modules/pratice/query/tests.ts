...
export async function querySelfTests(authorId: string, param: GetPracticeTestsQuery): Promise<GetPracticeTestsResponse> {
	const { page, perPage, searchTitle, sort } = param;
