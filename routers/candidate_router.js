...
router.get('/attempts/answers/:attemptId/page', tryCatch(testController.getAttemptPage));
router.get('/attempts/answers/:attemptId/data', tryCatch(testController.getAttemptDetails));
