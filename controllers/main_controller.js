const execute = require("../utilities/database");
...
async function getTests(req, res) {
  ...
  //   try {
  //     const [tests] = await execute(`SELECT id, title FROM tests`);
...
async function getTestById(req, res) {
  ...
  try {
    const [test] = await execute(`SELECT id, title FROM tests WHERE id = ?`, [
      testId,
    ]);
...
module.exports = { getTests, getTestById, submitTest };
